...
When I go to the root page
Then I should see links "日本語, Change Password" within the "user nav" section

Scenario: User nav links for logged in users
Given I am logged in as member
When I go to the root page
And I follow "Change Password" within the "user nav" section
Then I should be on that user's change_password page
